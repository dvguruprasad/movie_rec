    ...
    describe ".recommend" do
      context "when using similarity" do
        ...
        it "recommends all movies rated by a user if only one similar user is found" do
          ...
          similar_users = [Factory.build(:user, :name => "similar_user", :ratings => ratings)]
        ...
        it "recommends movies in descending order of their ratings" do
          ...
          similar_users = [Factory.create(:user, :name => "user_2", :ratings => ratings_user_2), Factory.create(:user, :name => "user_3", :ratings => ratings_user_3)]
